...
type ListMeta struct {
	...
	// Populated by the system.
	// Read-only.
	// See http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#concurrency-control-and-consistency
...
type VolumeSource struct {
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/volumes.md#emptydir
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/volumes.md#secrets
	...
	// kubelet's host machine and then exposed to the pod.
	// See http://releases.k8s.io/HEAD/examples/iscsi/README.md
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/persistent-volumes.md#persistentvolumeclaims
...
// See http://releases.k8s.io/HEAD/docs/user-guide/persistent-volumes.md
...
type PersistentVolumeSpec struct {
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/persistent-volumes.md#access-modes
...
type PersistentVolumeStatus struct {
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/persistent-volumes.md#phase
...
type PersistentVolumeClaimSpec struct {
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/persistent-volumes.md#access-modes-1
	AccessModes []PersistentVolumeAccessMode `json:"accessModes,omitempty"`
	// Resources represents the minimum resources the volume should have.
	// See http://releases.k8s.io/HEAD/docs/user-guide/persistent-volumes.md#resources
...
// See http://releases.k8s.io/HEAD/docs/design/secrets.md
...
type Probe struct {
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/pod-states.md#container-probes"
...
type ResourceRequirements struct {
	...
	// See http://releases.k8s.io/HEAD/docs/design/resources.md#resource-specifications
...
type Container struct {
	// Name of the container. This must be a DNS_LABEL. Each container
	...
	// Docker image name.
	// Optional.
	// See http://releases.k8s.io/HEAD/docs/user-guide/images.md
	Image string `json:"image,omitempty"`
	// The docker image's entrypoint is used if this is not provided.
	// Entrypoint array. Not executed within a shell. Cannot be updated.
	// Variable references $(VAR_NAME) are expanded using the container's environment. If a variable
	// cannot be resolved, the reference in the input string will be unchanged. The $(VAR_NAME) syntax
	// can be escaped with a double $$, ie: $$(VAR_NAME). Escaped references will never be expanded,
	// regardless of whether the variable exists or not.
	// Optional.
	// See http://releases.k8s.io/HEAD/docs/user-guide/containers.md#containers-and-commands
	Command []string `json:"command,omitempty"`
	// The docker image's cmd is used if this is not provided.
	// Arguments to the entrypoint. Cannot be updated.
	// Variable references $(VAR_NAME) are expanded using the container's environment. If a variable
	// cannot be resolved, the reference in the input string will be unchanged. The $(VAR_NAME) syntax
	// can be escaped with a double $$, ie: $$(VAR_NAME). Escaped references will never be expanded,
	// regardless of whether the variable exists or not.
	...
	// Cannot be updated.
	// Optional.
	// See http://releases.k8s.io/HEAD/docs/user-guide/images.md#updating-images
	ImagePullPolicy PullPolicy `json:"imagePullPolicy,omitempty"`
	// Security options the pod should run with.
	// Optional.
	// See http://releases.k8s.io/HEAD/docs/design/security_context.md
...
type Lifecycle struct {
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/container-environment.md#hook-details
...
type ContainerStatus struct {
	...
	// Container's ID in the format 'docker://<container_id>'.
	// See http://releases.k8s.io/HEAD/docs/user-guide/container-environment.md#container-information
	ContainerID string `json:"containerID,omitempty"`
}
...
type PodCondition struct {
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/pod-states.md#pod-conditions
...
type PodSpec struct {
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/volumes.md
	...
	// Cannot be updated.
	// Required.
	// See http://releases.k8s.io/HEAD/docs/user-guide/containers.md
	Containers []Container `json:"containers" patchStrategy:"merge" patchMergeKey:"name"`
	// Restart policy for all containers within the pod.
	// One of Always, OnFailure, Never.
	// Default to Always.
	// See http://releases.k8s.io/HEAD/docs/user-guide/pod-states.md#restartpolicy
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/node-selection/README.md
	NodeSelector map[string]string `json:"nodeSelector,omitempty"`

	// ServiceAccountName is the name of the ServiceAccount to use to run this pod.
	// See http://releases.k8s.io/HEAD/docs/design/service_accounts.md
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/images.md#specifying-imagepullsecrets-on-a-pod
...
type PodStatus struct {
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/pod-states.md#pod-phase
	...
	// of `docker inspect`.
	// See http://releases.k8s.io/HEAD/docs/user-guide/pod-states.md#container-statuses
...
type PodStatusResult struct {
	...
	// Populated by the system.
	// Read-only.
	// See http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#spec-and-status
...
type PodList struct {
	...
	// List of pods.
	// See http://releases.k8s.io/HEAD/docs/user-guide/pods.md
...
type ReplicationControllerSpec struct {
	...
	// Defaults to 1.
	// See http://releases.k8s.io/HEAD/docs/user-guide/replication-controller.md#what-is-a-replication-controller
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/labels.md#label-selectors
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/replication-controller.md#pod-template
	Template *PodTemplateSpec `json:"template,omitempty"`
}
...
type ReplicationController struct {
	...
	// Standard object's metadata. See http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata
	ObjectMeta `json:"metadata,omitempty"`
...
type ReplicationControllerList struct {
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/replication-controller.md
...
type ServiceSpec struct {
	...
	// Required.
	// See http://releases.k8s.io/HEAD/docs/user-guide/services.md#virtual-ips-and-service-proxies
	Ports []ServicePort `json:"ports"`

	// This service will route traffic to pods having labels matching this selector.
	// Label keys and values that must match in order to receive traffic for this service.
	// If empty, all pods are selected, if not specified, endpoints must be manually specified.
	// See http://releases.k8s.io/HEAD/docs/user-guide/services.md#overview
	Selector map[string]string `json:"selector,omitempty"`
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/services.md#external-services
...
type ServicePort struct {
	...
	// Optional.
	// See http://releases.k8s.io/HEAD/docs/user-guide/services.md#defining-a-service
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/services.md#type--nodeport
...
type ServiceAccount struct {
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/secrets.md
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/secrets.md#manually-specifying-an-imagepullsecret
...
type ServiceAccountList struct {
	...
	// See http://releases.k8s.io/HEAD/docs/design/service_accounts.md#service-accounts
...
type NodeSpec struct {
	...
	// See http://releases.k8s.io/HEAD/docs/admin/node.md#manual-node-administration"`
...
type NodeStatus struct {
	...
	// See http://releases.k8s.io/HEAD/docs/user-guide/persistent-volumes.md#capacity for more details.
	Capacity ResourceList `json:"capacity,omitempty"`
	// NodePhase is the recently observed lifecycle phase of the node.
	// See http://releases.k8s.io/HEAD/docs/admin/node.md#node-phase
	Phase NodePhase `json:"phase,omitempty"`
	// Conditions is an array of current observed node conditions.
	// See http://releases.k8s.io/HEAD/docs/admin/node.md#node-condition
	Conditions []NodeCondition `json:"conditions,omitempty" patchStrategy:"merge" patchMergeKey:"type"`
	// List of addresses reachable to the node.
	// Queried from cloud provider, if available.
	// See http://releases.k8s.io/HEAD/docs/admin/node.md#node-addresses
	Addresses []NodeAddress `json:"addresses,omitempty" patchStrategy:"merge" patchMergeKey:"type"`
	// NodeSystemInfo is a set of ids/uuids to uniquely identify the node.
	// See http://releases.k8s.io/HEAD/docs/admin/node.md#node-info
...
type NamespaceSpec struct {
	...
	// See http://releases.k8s.io/HEAD/docs/design/namespaces.md#finalizers
...
type NamespaceStatus struct {
	...
	// See http://releases.k8s.io/HEAD/docs/design/namespaces.md#phases
...
type LimitRangeList struct {
	...
	// See http://releases.k8s.io/HEAD/docs/design/admission_control_limit_range.md
...
type ResourceQuotaSpec struct {
	...
	// See http://releases.k8s.io/HEAD/docs/design/admission_control_resource_quota.md#admissioncontrol-plugin-resourcequota
...
type SecurityContext struct {
	...
	// The linux capabilites that should be added or removed.
	// See http://releases.k8s.io/HEAD/docs/design/security_context.md#security-context
	Capabilities *Capabilities `json:"capabilities,omitempty"`

	// Run the container in privileged mode.
	// Must match Container.Privileged or be unset.
	// Will be defaulted to Container.Privileged if left unset.
	// See http://releases.k8s.io/HEAD/docs/design/security_context.md#security-context
...
type RangeAllocation struct {
	TypeMeta `json:",inline"`
	// ObjectMeta is a Standard list metadata.
	// See http://releases.k8s.io/HEAD/docs/devel/api-conventions.md#metadata
	ObjectMeta `json:"metadata,omitempty"`
